...
{
    return(
        <div className='min-h-screen bg-[#111115] flex justify-center px-10' >
            <div className='w-full bg-[#18181C]/100 space-y-9 px-4 rounded-4xl border-1 border-[#3D3229] '>
                <Logo/>
                <h1 className="pt-10 pb-10 text-3xl md:text-4xl font-semibold text-white">Leet Pong Privacy Policy</h1>
                <p className="text-white/88">
                    ...
                    It has survived not only five <br/> centuries, but also the leap into electronic 
                    ...
                    by English versions from the 1914 translation by H. Rackham.<br/>
                </p>
            </div>
        </div>
    );
